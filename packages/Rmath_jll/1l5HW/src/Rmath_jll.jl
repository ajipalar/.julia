...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import Rmath_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("f50d1b31-88e8-58de-be2c-1cc44531875f"))
platforms = [Pkg.Artifacts.unpack_platform(e, "Rmath", artifacts_toml) for e in artifacts["Rmath"]]
...
if best_platform === nothing
    @debug("Unable to load Rmath; unsupported platform $(triplet(platform_key_abi()))")
else
